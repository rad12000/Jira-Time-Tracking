...
async function createAlarmAsync() {
  ...
  return await chrome.alarms.create("Reminder check", {
...
async function handleReminderIntervalAsync() {
  await jiraService.refreshClientAsync();
...
function displayWarningNotificationAsync(issueKey) {
  return new Promise(async (resolve, _) => {
    ...
    const id = await chrome.notifications.create(null, decisionAlertOptions);
    resolve(id);
  });
}
//#endregion
